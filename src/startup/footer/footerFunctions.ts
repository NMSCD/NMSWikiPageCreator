...
import { restoreDefaults, showSettings, switchTheme, updateDefaultValues } from "../../modules/footer";
import { deleteCharacter, glyphInputOnChange } from "../../modules/portalglyphs";
